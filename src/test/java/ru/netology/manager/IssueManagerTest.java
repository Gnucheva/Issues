...
class IssueManagerTest {
    ...
    private Issue issue1 = new Issue(1, true, "Yuliya", 3, new HashSet<>(Arrays.asList("label1", "label2", "label3")), new HashSet<>(Arrays.asList("julia", "mari", "peter")));
    private Issue issue2 = new Issue(2, false, "Yuliya", 10, new HashSet<>(Arrays.asList("label1", "label2", "label5")), new HashSet<>(Arrays.asList("julia", "anton", "peter")));
    ...
    private Issue issue4 = new Issue(4, false, "Lena", 25, new HashSet<>(Arrays.asList("label3", "label1", "label4")), new HashSet<>(Arrays.asList("mari", "lisa", "ani")));
    ...
    public class Empty {
        ...
        void mustReturnEmptyWhenFindByAuthor() {
            ...
            Collection<Issue> actual = manager.findByAuthor("Yuliya");
            assertEquals(expected, actual);
        }
        ...
        void mustReturnEmptyWhenFindByAssignee() {
            Collection<Issue> expected = new ArrayList<>();
            Collection<Issue> actual = manager.findByAssignee(new HashSet<String>(Arrays.asList("julia")));
            assertEquals(expected, actual);
        }
    ...
    public class MultipleItems {
        ...
        void mustFindByAuthor() {
            ...
            List<Issue> expected = new ArrayList<>(List.of(issue1, issue2));
            List<Issue> actual = manager.findByAuthor("Yuliya");
            assertEquals(expected, actual);
        }
